                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zCCBC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending CCBC because you wouldn't check it anyway.
    if (context == Context::Send_CCBC || context == Context::Send_zCCBC) {
