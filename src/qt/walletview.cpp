                                          ...
                                          walletModel(0)
{
	...
	// Pass through messages from informationPage
	connect(informationPage, SIGNAL(message(QString, QString, unsigned int)), this, SIGNAL(message(QString, QString, unsigned int)));
