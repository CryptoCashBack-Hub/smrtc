...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zccbcTracker->HasMintTx(hash))) {
            //zCCBC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZCCBC;
...
bool IsZCCBCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZCCBC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZCCBC || type == TransactionRecord::MNReward) {
